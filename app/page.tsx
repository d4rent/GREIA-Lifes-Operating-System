...
export default function Home() {
  return (
    <main className="flex min-h-screen flex-col items-center justify-between bg-black overflow-hidden">
      {/* Hero Section */}
      <div className="relative w-full h-screen flex items-center justify-center">
        ...
        {/* Navigation Links */}
        <nav className="absolute bottom-20 left-0 right-0 flex justify-center gap-12 text-white text-xl z-20 animate-fadeInUp">
